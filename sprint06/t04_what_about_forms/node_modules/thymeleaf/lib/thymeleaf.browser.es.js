...
import { deserialize as deserialize$1, serialize as serialize$1, clearChildren } from '@ultraq/dom-utils';
...
function deserialize(htmlString) {
  /* istanbul ignore if */
  {
    return deserialize$1(htmlString);
  }
}
/**
...
function serialize(documentFragment) {
  /* istanbul ignore if */
  {
    return serialize$1(documentFragment);
  }
}
...
async function extractFragment(dialectPrefix, fragmentInfo, context) {
  ...
  if (templateResolver) {
    ...
    return $(`[${dialectPrefix}\\:${NAME$9}^="${fragmentName}"]`, template) || $(`[data-${dialectPrefix}-${NAME$9}^="${fragmentName}"]`, template);
  }
